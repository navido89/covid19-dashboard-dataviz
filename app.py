...
def plot12():
    ...
    cdc_variants_data2 = pd.read_csv("https://www.cdc.gov/coronavirus/2019-ncov/downloads/transmission/04052021_Web-UpdateCSV-TABLE.csv")
...
def vairant_summary():
    # Pull in the data from the cdc 
    cdc_variants_data = pd.read_csv("https://www.cdc.gov/coronavirus/2019-ncov/downloads/transmission/04052021_Web-UpdateCSV-TABLE.csv")
